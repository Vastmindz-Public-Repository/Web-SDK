...
export interface RPPGSocketConfig {
    ...
    /***/
    onMessage?: (arg0: string, arg1: MessageEvents) => void;
 ...
 */
export declare enum RPPGSocketOnMessageType {
    MEASUREMENT_MEAN_DATA = 0,
    MEASUREMENT_STATUS = 1,
    SENDING_RATE_WARNING = 2,
    MEASUREMENT_PROGRESS = 3,
    MEASUREMENT_SIGNAL = 4,
    MOVING_WARNING = 5,
    BLOOD_PRESSURE = 6,
    SIGNAL_QUALITY = 7,
    INTERFERENCE_WARNING = 8,
    UNSTABLE_CONDITIONS_WARNING = 9
}
/**
